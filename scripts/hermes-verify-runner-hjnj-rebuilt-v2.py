...
BODY = r'''# -*- coding: utf-8 -*-
"""hermes-verify-hjnj-rebuilt-v2.py — qhzy-黄帝内经 重建修复 1-14章 聚焦验证（ad-hoc, tempfile OS-safe）"""
import sys, re, os
import openpyxl
...
fd, tmp_path = tempfile.mkstemp(prefix='hermes-verify-hjnj-rebuilt-v2-', suffix='.py', dir=tempfile.gettempdir())
