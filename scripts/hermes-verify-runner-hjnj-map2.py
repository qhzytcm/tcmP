...
BODY = r'''# -*- coding: utf-8 -*-
"""hermes-verify-hjnj-map2-final.py — qhzy-黄帝内经 0映射2（翟双庆）聚焦验证（ad-hoc）"""
...
# 4. 0目录 素问/灵枢 81 篇仍完整（未被0映射2操作破坏）
sw, ls = [], []
...
fd, tmp_path = tempfile.mkstemp(prefix='hermes-verify-hjnj-map2-', suffix='.py', dir=tempfile.gettempdir())
